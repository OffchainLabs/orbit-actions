...
1. Update the wasm module root on the Rollup contract in the parent chain using [Set wasmModuleRoot action](scripts/foundry/arbos-upgrades/set-wasm-module-root)
