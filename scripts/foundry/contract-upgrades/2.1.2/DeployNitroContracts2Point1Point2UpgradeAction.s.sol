 ...
 */
contract DeployNitroContracts2Point1Point2UpgradeActionScript is
  DeploymentHelpersScript
{
  function run() public {
    ...
    address newBridgeImpl = deployBytecodeFromJSON(
      '/node_modules/@arbitrum/nitro-contracts-2.1.3/build/contracts/src/bridge/ERC20Bridge.sol/ERC20Bridge.json'
    );
