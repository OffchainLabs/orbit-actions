...
This script empowers `AddWasmCacheManagerAction` contract enables CacheManager for the Orbit chain. Please note that the prerequisite for this action is running the ArbOS31 version which introduces Stylus support.
