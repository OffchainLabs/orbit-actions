...
#ARBOS32
export WASM_MODULE_ROOT=0x184884e1eb9fefdc158f6c8ac912bb183bf3cf83f0090317e0bc4ac5860baa39
...
forge script --private-key $DEPLOYMENT_PK --rpc-url $RPC --broadcast  DeployNitroContracts1Point2Point1UpgradeActionScript -vvv --verify --skip-simulation
#export UPGRADE_ACTION_ADDRESS=
#forge script --private-key $OWNER_PK --rpc-url $RPC --broadcast ExecuteNitroContracts1Point2Point1UpgradeScript -vvv --verify --skip-simulation
