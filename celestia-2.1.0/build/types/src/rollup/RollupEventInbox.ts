...
export interface RollupEventInboxInterface extends utils.Interface {
  functions: {
...
export interface RollupEventInbox extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: RollupEventInboxInterface;
