...
export interface AdminFallbackProxyInterface extends utils.Interface {
  functions: {};
...
export interface AdminFallbackProxy extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: AdminFallbackProxyInterface;
