...
export interface ProxyAdminForBindingInterface extends utils.Interface {
  functions: {
...
export interface ProxyAdminForBinding extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ProxyAdminForBindingInterface;
