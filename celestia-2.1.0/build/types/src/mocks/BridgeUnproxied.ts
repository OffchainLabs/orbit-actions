...
export interface BridgeUnproxiedInterface extends utils.Interface {
  functions: {
    "DUMMYVAR()": FunctionFragment;
  ...
  encodeFunctionData(functionFragment: "DUMMYVAR", values?: undefined): string;
  encodeFunctionData(
  ...
  decodeFunctionResult(functionFragment: "DUMMYVAR", data: BytesLike): Result;
...
export interface BridgeUnproxied extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: BridgeUnproxiedInterface;
  ...
  functions: {
    DUMMYVAR(overrides?: CallOverrides): Promise<[BigNumber]>;
  ...
  populateTransaction: {
    DUMMYVAR(overrides?: CallOverrides): Promise<PopulatedTransaction>;
