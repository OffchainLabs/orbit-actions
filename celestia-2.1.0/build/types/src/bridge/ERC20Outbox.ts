...
export interface ERC20OutboxInterface extends utils.Interface {
  functions: {
    ...
    "l2ToL1WithdrawalAmount()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "l2ToL1WithdrawalAmount",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface ERC20Outbox extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ERC20OutboxInterface;
  ...
  functions: {
    ...
    l2ToL1WithdrawalAmount(overrides?: CallOverrides): Promise<[BigNumber]>;
