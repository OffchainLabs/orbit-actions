...
export class IEthBridge__factory {
  static readonly abi = _abi;
  static createInterface(): IEthBridgeInterface {
    return new utils.Interface(_abi) as IEthBridgeInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): IEthBridge {
    return new Contract(address, _abi, signerOrProvider) as IEthBridge;
  }
}
