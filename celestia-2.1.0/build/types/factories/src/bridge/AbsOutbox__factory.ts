...
export class AbsOutbox__factory {
  static readonly abi = _abi;
  static createInterface(): AbsOutboxInterface {
    return new utils.Interface(_abi) as AbsOutboxInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): AbsOutbox {
    return new Contract(address, _abi, signerOrProvider) as AbsOutbox;
  }
}
