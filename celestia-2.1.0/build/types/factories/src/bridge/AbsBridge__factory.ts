...
export class AbsBridge__factory {
  static readonly abi = _abi;
  static createInterface(): AbsBridgeInterface {
    return new utils.Interface(_abi) as AbsBridgeInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): AbsBridge {
    return new Contract(address, _abi, signerOrProvider) as AbsBridge;
  }
}
