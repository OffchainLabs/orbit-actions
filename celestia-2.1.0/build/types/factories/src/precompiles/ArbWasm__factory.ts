...
export class ArbWasm__factory {
  static readonly abi = _abi;
  static createInterface(): ArbWasmInterface {
    return new utils.Interface(_abi) as ArbWasmInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): ArbWasm {
    return new Contract(address, _abi, signerOrProvider) as ArbWasm;
  }
}
